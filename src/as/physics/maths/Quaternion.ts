...
export class Quaternion {
   ...
   */
  toAxisAngle(targetAxis: Vec3): [Vec3, f32] {
   ...
   */
  slerp(toQuat: Quaternion, t: f32, target: Quaternion): Quaternion {
    target = target || new Quaternion();
   ...
   */
  integrate(angularVelocity: Vec3, dt: f32, angularFactor: Vec3, target: Quaternion): Quaternion {
    target = target || new Quaternion();

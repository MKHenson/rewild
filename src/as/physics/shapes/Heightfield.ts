...
export class Heightfield extends Shape {
   ...
   */
  getRectMinMax(iMinX: i32, iMinY: i32, iMaxX: i32, iMaxY: i32, result: f32[] = []): void {
   ...
   * @return {boolean}
   */
  getIndexOfPosition(x: i32, y: i32, result: f32[], clamp: boolean): boolean {
  ...
  getTriangleAt(x: i32, y: i32, edgeClamp: boolean, a: Vec3, b: Vec3, c: Vec3): boolean {
  ...
  getNormalAt(x: i32, y: i32, edgeClamp: boolean, result: Vec3): void {
   ...
   * @return {number}
   */
  getHeightAt(x: i32, y: i32, edgeClamp: boolean): f32 {
    const data = this.data;
  ...
  getCachedConvexTrianglePillar(xi: i32, yi: i32, getUpperTriangle: boolean): Pillar {
  ...
  clearCachedConvexTrianglePillar(xi: i32, yi: i32, getUpperTriangle: boolean) {
   ...
   * @param {Vec3} scale
   */
  setHeightsFromImage(image, scale: Vec3): void {

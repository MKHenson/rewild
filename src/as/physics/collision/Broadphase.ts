...
export abstract class Broadphase {
  ...
  needBroadphaseCollision(bodyA: Body, bodyB: Body): boolean {
    ...
    // Check types
    if (
      ((bodyA.type & BodyType.STATIC) !== 0 || bodyA.sleepState === SleepState.SLEEPING) &&
      ((bodyB.type & BodyType.STATIC) !== 0 || bodyB.sleepState === SleepState.SLEEPING)
    ) {
   ...
   * @param {array} pairs2
   */
  intersectionTest(bodyA: Body, bodyB: Body, pairs1, pairs2): void {
  ...
  doBoundingSphereBroadphase(bodyA: Body, bodyB: Body, pairs1, pairs2): void {
   ...
   * @param {Array} pairs2
   */
  doBoundingBoxBroadphase(bodyA: Body, bodyB: Body, pairs1, pairs2): void {
  ...
  makePairsUnique(pairs1, pairs2): void {
  ...
  static boundingSphereCheck(bodyA: Body, bodyB: Body): f32 {
    const dist = bsc_dist;

 ...
 * @author saharan
 */
export class BoxBoxCollisionDetector extends CollisionDetector {
  clipVertices1: Float32Array;
  clipVertices2: Float32Array;
  used: Float32Array;
  INF: f32;
  ...
  detectCollision(shape1: Box, shape2: Box, manifold: ContactManifold) {
    ...
    const V1 = b1.elements;
    const V2 = b2.elements;

    const D1 = b1.dimentions;
    const D2 = b2.dimentions;
    ...
    const dz = p2z - p1z;
    // distance
    const w1 = b1.halfWidth;
    const h1 = b1.halfHeight;
    const d1 = b1.halfDepth;
    const w2 = b2.halfWidth;
    const h2 = b2.halfHeight;
    const d2 = b2.halfDepth;
    // direction
    ...
    let a7x = a1y * a4z - a1z * a4y;
    let a7y = a1z * a4x - a1x * a4z;
    let a7z = a1x * a4y - a1y * a4x;
    let a8x = a1y * a5z - a1z * a5y;
    let a8y = a1z * a5x - a1x * a5z;
    let a8z = a1x * a5y - a1y * a5x;
    let a9x = a1y * a6z - a1z * a6y;
    let a9y = a1z * a6x - a1x * a6z;
    let a9z = a1x * a6y - a1y * a6x;
    let aax = a2y * a4z - a2z * a4y;
    let aay = a2z * a4x - a2x * a4z;
    let aaz = a2x * a4y - a2y * a4x;
    let abx = a2y * a5z - a2z * a5y;
    let aby = a2z * a5x - a2x * a5z;
    let abz = a2x * a5y - a2y * a5x;
    let acx = a2y * a6z - a2z * a6y;
    let acy = a2z * a6x - a2x * a6z;
    let acz = a2x * a6y - a2y * a6x;
    let adx = a3y * a4z - a3z * a4y;
    let ady = a3z * a4x - a3x * a4z;
    let adz = a3x * a4y - a3y * a4x;
    let aex = a3y * a5z - a3z * a5y;
    let aey = a3z * a5x - a3x * a5z;
    let aez = a3x * a5y - a3y * a5x;
    let afx = a3y * a6z - a3z * a6y;
    let afy = a3z * a6x - a3x * a6z;
    let afz = a3x * a6y - a3y * a6x;
    // right or left flags
    let right1: boolean = false;
    let right2: boolean = false;
    let right3: boolean = false;
    let right4: boolean = false;
    let right5: boolean = false;
    let right6: boolean = false;
    let right7: boolean = false;
    let right8: boolean = false;
    let right9: boolean = false;
    let righta: boolean = false;
    let rightb: boolean = false;
    let rightc: boolean = false;
    let rightd: boolean = false;
    let righte: boolean = false;
    let rightf: boolean = false;
    ...
    if (minIndex > 5) {
      ...
      let t = (vx * (n1x - n2x * dot1) + vy * (n1y - n2y * dot1) + vz * (n1z - n2z * dot1)) / (1 - dot1 * dot1);
      manifold.addPoint(
        v1x + n1x * t + nx * depth * 0.5,
        v1y + n1y * t + ny * depth * 0.5,
        v1z + n1z * t + nz * depth * 0.5,
        nx,
        ny,
        nz,
        depth,

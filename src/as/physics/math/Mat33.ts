...
export class Mat33 {
  ...
  set(e00: f32, e01: f32, e02: f32, e10: f32, e11: f32, e12: f32, e20: f32, e21: f32, e22: f32): Mat33 {
  ...
  transpose(m: Mat33 | null = null): Mat33 {
    if (m != null) {
      var a = m.elements;
  ...
  clone(): Mat33 {
    return new Mat33().fromArray32(this.elements);
  }
  ...
  fromArray(array: f32[], offset = 0): Mat33 {
    for (var i = 0; i < 9; i++) {

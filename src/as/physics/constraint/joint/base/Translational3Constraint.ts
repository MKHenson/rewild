...
export class Translational3Constraint {
  ...
  upperLimit1: f32;
  limitVelocity1: f32;
  limitState1 = 0; // -1: at lower, 0: locked, 1: at upper, 2: unlimited
  enableMotor1 = false;
  motorSpeed1: f32;
  maxMotorForce1: f32;
  ...
  upperLimit2: f32;
  limitVelocity2: f32;
  limitState2 = 0; // -1: at lower, 0: locked, 1: at upper, 2: unlimited
  enableMotor2 = false;
  motorSpeed2: f32;
  maxMotorForce2: f32;
  ...
  upperLimit3: f32;
  limitVelocity3: f32;
  limitState3 = 0; // -1: at lower, 0: locked, 1: at upper, 2: unlimited
  enableMotor3 = false;
  motorSpeed3: f32;
  maxMotorForce3: f32;

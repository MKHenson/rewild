...
export class Rotational3Constraint {
  cfm1: f32;
  cfm2: f32;
  cfm3: f32;
  i1e00: f32;
  ...
  upperLimit1: f32;
  limitVelocity1: f32;
  limitState1: i32; // -1: at lower, 0: locked, 1: at upper, 2: free
  enableMotor1: boolean;
  motorSpeed1: f32;
  maxMotorForce1: f32;
  maxMotorImpulse1: f32;
  lowerLimit2: f32;
  upperLimit2: f32;
  limitVelocity2: f32;
  limitState2: i32; // -1: at lower, 0: locked, 1: at upper, 2: free
  enableMotor2: boolean;
  motorSpeed2: f32;
  maxMotorForce2: f32;
  maxMotorImpulse2: f32;
  lowerLimit3: f32;
  upperLimit3: f32;
  limitVelocity3: f32;
  limitState3: i32; // -1: at lower, 0: locked, 1: at upper, 2: free
  enableMotor3: boolean;
  motorSpeed3: f32;
  maxMotorForce3: f32;
  maxMotorImpulse3: f32;
  ...
  kv00: f32; // diagonals without CFMs
  kv11: f32;
  kv22: f32;
  ...
  constructor(joint: Joint, limitMotor1: LimitMotor, limitMotor2: LimitMotor, limitMotor3: LimitMotor) {
    this.cfm1 = NaN;
    this.cfm2 = NaN;
    this.cfm3 = NaN;
    this.i1e00 = NaN;
  ...
  preSolve(timeStep: f32, invTimeStep: f32): void {
    ...
    this.k00 =
      this.ax1 * (this.a1x1 + this.a2x1) + this.ay1 * (this.a1y1 + this.a2y1) + this.az1 * (this.a1z1 + this.a2z1);
    this.k01 =
      this.ax1 * (this.a1x2 + this.a2x2) + this.ay1 * (this.a1y2 + this.a2y2) + this.az1 * (this.a1z2 + this.a2z2);
    this.k02 =
      this.ax1 * (this.a1x3 + this.a2x3) + this.ay1 * (this.a1y3 + this.a2y3) + this.az1 * (this.a1z3 + this.a2z3);
    this.k10 =
      this.ax2 * (this.a1x1 + this.a2x1) + this.ay2 * (this.a1y1 + this.a2y1) + this.az2 * (this.a1z1 + this.a2z1);
    this.k11 =
      this.ax2 * (this.a1x2 + this.a2x2) + this.ay2 * (this.a1y2 + this.a2y2) + this.az2 * (this.a1z2 + this.a2z2);
    this.k12 =
      this.ax2 * (this.a1x3 + this.a2x3) + this.ay2 * (this.a1y3 + this.a2y3) + this.az2 * (this.a1z3 + this.a2z3);
    this.k20 =
      this.ax3 * (this.a1x1 + this.a2x1) + this.ay3 * (this.a1y1 + this.a2y1) + this.az3 * (this.a1z1 + this.a2z1);
    this.k21 =
      this.ax3 * (this.a1x2 + this.a2x2) + this.ay3 * (this.a1y2 + this.a2y2) + this.az3 * (this.a1z2 + this.a2z2);
    this.k22 =
      this.ax3 * (this.a1x3 + this.a2x3) + this.ay3 * (this.a1y3 + this.a2y3) + this.az3 * (this.a1z3 + this.a2z3);

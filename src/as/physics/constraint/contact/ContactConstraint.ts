...
export class ContactConstraint extends Constraint {
  ...
  preSolve(timeStep: f32, invTimeStep: f32): void {
    ...
    for (let i: i32 = 0; i < this.num; i++) {
      ...
      this.tmp.set(
        lv2.x + this.tmpC2.x - (lv1.x + this.tmpC1.x),
        lv2.y + this.tmpC2.y - (lv1.y + this.tmpC1.y),
        lv2.z + this.tmpC2.z - (lv1.z + this.tmpC1.z)
      );
  ...
  solve(): void {
    ...
    while (true) {
      ...
      rvn =
        _Math.dotVectors(this.tmp, c!.tan) +
        _Math.dotVectors(this.tmpav2, c!.tanT2) -
        _Math.dotVectors(this.tmpav1, c!.tanT1);
      ...
      rvn =
        _Math.dotVectors(this.tmp, c!.bin) +
        _Math.dotVectors(this.tmpav2, c!.binT2) -
        _Math.dotVectors(this.tmpav1, c!.binT1);
      ...
      rvn =
        _Math.dotVectors(this.tmp, c!.nor) +
        _Math.dotVectors(this.tmpav2, c!.norT2) -
        _Math.dotVectors(this.tmpav1, c!.norT1);

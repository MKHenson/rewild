...
// import { LinearFilter } from "../_constants";
...
//   constructor(width: i32, height: i32, options) {
//     super();
...
//   setSize(width: i32, height: i32, depth = 1) {
//     if (
//       this.width !== width ||
//       this.height !== height ||
//       this.depth !== depth
...
//   clone() {
//     return new WebGLRenderTarget(this.width, this.height, this.texture).copy(
//       this
//     );
//   }

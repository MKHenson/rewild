            ...
            {this.props.errorType === 'WGPU' ? (
              <div>
                <Typography variant="body1">
                  ...
                  <a href="https://www.google.com/intl/en_ie/chrome/canary/">
                    Chrome Canary
                  </a>{' '}
                  on desktop behind an experimental flag. You can enable with
                  the following flag:
                ...
                <Typography variant="body1">
                  ...
                  , enabled by the prefs below:{' '}
                  <pre>dom.webgpu.enabled and gfx.webrender.all</pre>
                </Typography>
                <Typography variant="body1">

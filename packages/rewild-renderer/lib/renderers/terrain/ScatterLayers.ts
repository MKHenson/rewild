...
export const SCATTER_LAYERS: Record<string, ScatterLayer> = {
  ...
  palm_01: {
    ...
    geometryId: 'palm-01',
    cullDistance: 420,
    impostor: { fromDistance: 180, views: 8, tileSize: 128 },
    ...
    wind: { amplitude: 4.6, frequency: 0.4, flutter: 0.5 },
    authoredNormals: true,
    foliage: true,
  },
  palm_02: {
  ...
  date_palm_01: {
    ...
    wind: { amplitude: 4.5, frequency: 0.4, flutter: 0.5 },
    authoredNormals: true,
    foliage: true,
  },
  fern_01: {
    ...
    geometryId: 'fern-01',
    cullDistance: 420,
    impostor: { fromDistance: 120, views: 2, tileSize: 32 },
    jitter: { scale: { from: 0.7, to: 1.3 }, yaw: FULL_TURN, tilt: 6 },
    yOffset: -0.027,
    alignToNormal: 0.6,
    footprint: 1.58,
    wind: { amplitude: 2.15, frequency: 0.9, flutter: 0.6 },
    authoredNormals: true,
    foliage: true,
    castShadow: false,
  },
  desert_plains_01: {
    name: 'desert_plains_01',
    geometryId: 'plains-01',
    cullDistance: 420,
    impostor: { fromDistance: 120, views: 2, tileSize: 32 },
    jitter: { scale: { from: 0.8, to: 1.3 }, yaw: FULL_TURN, tilt: 3 },

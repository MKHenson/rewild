...
export class Heightfield extends Shape {
   ...
   */
  constructor(data: f32[][], maxValue: f32 | null = null, minValue: f32 | null = null, elementSize: f32) {
   ...
   * @param {number} value
   */
  setHeightValueAtIndex(xi: i32, yi: i32, value: f32) {
    const data = this.data;
    data[xi][yi] = value;
   ...
   */
  getRectMinMax(iMinX: i32, iMinY: i32, iMaxX: i32, iMaxY: i32, result: i32[]) {
    result = result || [];
   ...
   * @return {boolean}
   */
  getIndexOfPosition(x: f32, y: f32, result: f32[], clamp: boolean) {
  ...
  getCachedConvexTrianglePillar(xi: i32, yi: i32, getUpperTriangle: boolean) {
  ...
  getConvexTrianglePillar(xi: i32, yi: i32, getUpperTriangle: boolean): void {
    ...
    const h =
      (Mathf.min(data[xi][yi], data[xi + 1][yi], data[xi][yi + 1], data[xi + 1][yi + 1]) - this.minValue) / 2 +
      this.minValue;

...
export class GridBroadphase extends Broadphase {
  ...
  collisionPairs(world: World, pairs1: Body[], pairs2: Body[]): void {
    ...
    function addBoxToBins(
      ...
      let yoff0: i32 = ((y0 - ymin) * ymult) | 0;
      let zoff0: i32 = ((z0 - zmin) * zmult) | 0;
      let xoff1: i32 = i32(Mathf.ceil((x1 - xmin) * xmult));
      let yoff1: i32 = i32(Mathf.ceil((y1 - ymin) * ymult));
      let zoff1: i32 = i32(Mathf.ceil((z1 - zmin) * zmult));

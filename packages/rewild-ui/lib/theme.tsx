export const theme = {
  colors: {
    ...
    onWarning400: 'var(--on-warning-400)',
    onWarning500: 'var(--on-warning-500)',
    onWarning600: 'var(--on-warning-600)',
    fontSizeSmall: 'var(--font-size-s)',
    fontSizeMedium: 'var(--font-size-m)',
    fontSizeLarge: 'var(--font-size-l)',

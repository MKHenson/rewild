import { create2DArray } from "rewild-common";
...
import { f32Array, i16Array } from "../../utils";
...
export class Trimesh extends Shape {
  ...
  constructor(vertices: i32[], indices: i16[]) {
     ...
     * @type {Array}
     */
    this.vertices = f32Array(vertices);
  ...
  static createTorus(
    radius: f32 = 1,
    tube: f32 = 0.5,
    radialSegments: i32 = 0,
    tubularSegments: i32 = 0,
    arc: f32 = Mathf.PI * 2
  ): Trimesh {
    radius = radius || 1;
    tube = tube || 0.5;

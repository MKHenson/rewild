...
export class RotationalConstraint {
  cfm: f32;
  i1e00: f32;
  i1e01: f32;
  i1e02: f32;
  ...
  constructor(joint: Joint, limitMotor: LimitMotor) {
    this.cfm = NaN;
    this.i1e00 = NaN;
    this.i1e01 = NaN;
    this.i1e02 = NaN;
  ...
  preSolve(timeStep: f32, invTimeStep: f32): void {
    ...
    this.motorDenom =
      this.ax * (this.a1x + this.a2x) + this.ay * (this.a1y + this.a2y) + this.az * (this.a1z + this.a2z);

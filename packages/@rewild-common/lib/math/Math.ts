...
export class Vector3Test {
  ...
  set(x: f32, y: f32, z: f32): Vector3Test {
    this.x = x;
    this.y = y;
    this.z = z;
    return this;
...
//###########################################################################################
export class Matrix4Test {
  raw: Float32Array;

  constructor() {
    this.raw = Matrix4Test.identity();
  }

  //....................................................................
  //Transformations Methods
  vtranslate(v: Vector3Test): Matrix4Test {
    Matrix4Test.translate(this.raw, v.x, v.y, v.z);
    return this;
  }
  translate(x: f32, y: f32, z: f32): Matrix4Test {
    Matrix4Test.translate(this.raw, x, y, z);
    return this;
  }

  rotateY(rad: f32): Matrix4Test {
    Matrix4Test.rotateY(this.raw, rad);
    return this;
  }
  rotateX(rad: f32): Matrix4Test {
    Matrix4Test.rotateX(this.raw, rad);
    return this;
  }
  rotateZ(rad: f32): Matrix4Test {
    Matrix4Test.rotateZ(this.raw, rad);
    return this;
  }

  vscale(vec3: Vector3Test): Matrix4Test {
    Matrix4Test.scale(this.raw, vec3.x, vec3.y, vec3.z);
    return this;
  }
  scale(x: f32, y: f32, z: f32): Matrix4Test {
    Matrix4Test.scale(this.raw, x, y, z);
    return this;
  }

  invert(): Matrix4Test {
    Matrix4Test.invert(this.raw, null);
    return this;
  }
